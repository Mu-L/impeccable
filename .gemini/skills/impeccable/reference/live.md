...
```bash
node .gemini/skills/impeccable/scripts/live-codex-worker.mjs --status
node .gemini/skills/impeccable/scripts/live-codex-worker.mjs --stop
```
...
```bash
node .gemini/skills/impeccable/scripts/live-codex-worker.mjs --stop  # only when codexWorker.enabled was true
