...
```bash
node .kiro/skills/impeccable/scripts/live-codex-worker.mjs --status
node .kiro/skills/impeccable/scripts/live-codex-worker.mjs --stop
```
...
```bash
node .kiro/skills/impeccable/scripts/live-codex-worker.mjs --stop  # only when codexWorker.enabled was true
