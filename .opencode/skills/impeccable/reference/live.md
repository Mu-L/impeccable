...
```bash
node .opencode/skills/impeccable/scripts/live-codex-worker.mjs --status
node .opencode/skills/impeccable/scripts/live-codex-worker.mjs --stop
```
...
```bash
node .opencode/skills/impeccable/scripts/live-codex-worker.mjs --stop  # only when codexWorker.enabled was true
