...
```bash
node .rovodev/skills/impeccable/scripts/live-codex-worker.mjs --status
node .rovodev/skills/impeccable/scripts/live-codex-worker.mjs --stop
```
...
```bash
node .rovodev/skills/impeccable/scripts/live-codex-worker.mjs --stop  # only when codexWorker.enabled was true
