...
```bash
node .qoder/skills/impeccable/scripts/live-codex-worker.mjs --status
node .qoder/skills/impeccable/scripts/live-codex-worker.mjs --stop
```
...
```bash
node .qoder/skills/impeccable/scripts/live-codex-worker.mjs --stop  # only when codexWorker.enabled was true
