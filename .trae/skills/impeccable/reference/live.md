...
```bash
node .trae/skills/impeccable/scripts/live-codex-worker.mjs --status
node .trae/skills/impeccable/scripts/live-codex-worker.mjs --stop
```
...
```bash
node .trae/skills/impeccable/scripts/live-codex-worker.mjs --stop  # only when codexWorker.enabled was true
