...
```bash
node .cursor/skills/impeccable/scripts/live-codex-worker.mjs --status
node .cursor/skills/impeccable/scripts/live-codex-worker.mjs --stop
```
...
```bash
node .cursor/skills/impeccable/scripts/live-codex-worker.mjs --stop  # only when codexWorker.enabled was true
