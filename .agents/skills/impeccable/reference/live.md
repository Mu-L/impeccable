...
```bash
node .agents/skills/impeccable/scripts/live-codex-worker.mjs --status
node .agents/skills/impeccable/scripts/live-codex-worker.mjs --stop
```
...
```bash
node .agents/skills/impeccable/scripts/live-codex-worker.mjs --stop  # only when codexWorker.enabled was true
